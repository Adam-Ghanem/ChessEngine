    ...
    <main className="app-shell chessiq-shell">
      ...
      <section className="product-page">
        <div className="product-intro">
          <p className="eyebrow">ChessIQ progress</p>
          <h1>Progress measured from your own work.</h1>
          <p>No invented ratings or testimonials: this screen summarizes saved games, actual engine sessions, learning checkpoints, puzzle attempts, and opening reviews.</p>
        </div>
        {!isAuthenticated ? (
          <section className="auth-gate"><Activity size={28}/><h2>Sign in to build your progress record.</h2><button className="account-button account-primary" onClick={() => startLogin()}>Sign in</button></section>
        ) : (
          <>
