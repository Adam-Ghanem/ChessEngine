...
describe("ChessIQ public product routing", () => {
  it("exposes seven real product destinations including Games and Coach", () => {
  ...
  it("keeps preview-only navigation copy out of product pages", () => {
    const files = ["pages/Analyze.tsx", "pages/Play.tsx", "pages/Games.tsx", "pages/Learn.tsx", "pages/Puzzles.tsx", "pages/Progress.tsx", "pages/Coach.tsx"];
  ...
  it("aliases review to Analyze, makes Play the root route, and exposes Games, Progress, and Coach", () => {
